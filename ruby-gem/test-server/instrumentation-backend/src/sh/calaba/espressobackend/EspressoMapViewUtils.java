 ...
 */
public class EspressoMapViewUtils {
		
	private MapView getMapView() {
		MapViewCaptorMatcher mapViewCaptorMatcher = new MapViewCaptorMatcher();
		Espresso.onView(ViewMatchers.isAssignableFrom(MapView.class)).perform(new ViewCaptor());
		return (MapView) (mapViewCaptorMatcher.getCapturedViews().isEmpty() ? null : mapViewCaptorMatcher.getCapturedViews().get(0));
	}
	 ...
	 * @see EspressoMapViewUtils#toString(OverlayItem, boolean)
	 */
